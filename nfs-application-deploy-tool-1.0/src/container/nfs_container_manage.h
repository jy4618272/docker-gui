...
#ifdef DEBUG
#define CONTAINER_MANAGE_FILE UI_DIR_PATH_FOR_DEBUG"/nfs_container_manage.ui"
#define CREATE_CONTAINS_FILE UI_DIR_PATH_FOR_DEBUG"/nfs_container_manage_createcontains.ui"
#define CONTAINER_MANAGE_GUARD_FILE UI_DIR_PATH_FOR_DEBUG"/nfs_container_manage_guard.ui"
#define CONTAINER_MANAGE_LSGUARD_FILE UI_DIR_PATH_FOR_DEBUG"/nfs_container_manage_lsguard.ui"
#else
#define CONTAINER_MANAGE_FILE UI_DIR_PATH_FOR_BUILD"/nfs_container_manage.ui"
#define CREATE_CONTAINS_FILE UI_DIR_PATH_FOR_BUILD"/nfs_container_manage_createcontains.ui"
#define CONTAINER_MANAGE_GUARD_FILE UI_DIR_PATH_FOR_BUILD"/nfs_container_manage_guard.ui"
#define CONTAINER_MANAGE_LSGUARD_FILE UI_DIR_PATH_FOR_BUILD"/nfs_container_manage_lsguard.ui"
#endif
...
//void contains_message(GtkMessageType type,gpointer buf);
//void contains_message(GtkMessageType type,char  *buf);
void docker_contain();
